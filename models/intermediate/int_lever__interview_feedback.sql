...
join_w_feedback as (
    ...
    left join interview_feedback 
        ...
        {{ 'and interview.source_relation = interview_feedback.source_relation' if var('lever_union_schemas', false) or var('lever_union_databases', false) }}
    left join feedback_form 
        on interview_feedback.feedback_form_id = feedback_form.feedback_form_id
        {{ 'and interview_feedback.source_relation = feedback_form.source_relation' if var('lever_union_schemas', false) or var('lever_union_databases', false) }}
)
